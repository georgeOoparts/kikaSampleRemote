...
public class H_99_13_mojiHonban : MonoBehaviour
{
    ...
    private string[,] m1_5 = new string[,]
    {
        ...
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","0","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","2","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","4","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","6","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","7","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","8","9"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","のそれぞれ","延長した","直線とする           ","[公準P-2]   　　　　　","任意の直線を連続して延ばすこと。","","","","","10","11"/*,"99"*/},
