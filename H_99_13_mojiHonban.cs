...
public class H_99_13_mojiHonban : MonoBehaviour {
    ...
    private string[,] m1_6 = new string[,]//m1_6w
    {
        ...
        {"このとき、", "直線DC","を引く","         ","[公準P-1]",
            ...
            "","4","6","7"},
        //now
        {"DB", "は","AC","と","等しく","、","BC","を","共有しているから、","","","","","","","","0","99","99"},
        {"DB", "は","AC","と","等しく","、","BC","を","共有しているから、","","","","","","","","2","99","99"},
        {"DB", "は","AC","と","等しく","、","BC","を","共有しているから、","","","","","","","","4","99","99"},
        {"DB", "は","AC","と","等しく","、","BC","を","共有しているから、","","","","","","","","6","99","99"},
        {"DB", "は","AC","と","等しく","、","BC","を","共有しているから、","","","","","","","","8","99","99"},
