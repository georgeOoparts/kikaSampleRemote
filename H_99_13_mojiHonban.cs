...
public class H_99_13_mojiHonban : MonoBehaviour
{
    ...
    private string[,] m1_5 = new string[,]
    {
        ...
        {"等しい二辺", "に対する","残りの角","もそれぞれ等しい","[命題I-4]","","","","","","","0"},
        {"等しい二辺", "に対する","残りの角","もそれぞれ等しい","[命題I-4]","","","","","","","2"},

        {"よって、", "FBC","と","GCB","、","BCF","と","CBG","は等しい。","","","1"},
        {"よって、", "FBC","と","GCB","、","BCF","と","CBG","は等しい。","","","3"},
        {"よって、", "FBC","と","GCB","、","BCF","と","CBG","は等しい。","","","5"},
        {"よって、", "FBC","と","GCB","、","BCF","と","CBG","は等しい。","","","7"},

        {"角ABG", "と","角ACF","は等しいが、","","","","","","","","0"},
        {"角ABG", "と","角ACF","は等しいが、","","","","","","","","2"},

        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","1"},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","3"},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","5"},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","7"},


        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","1"},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","3"},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","5"},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","7"},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","9"},


        {"ゆえに、", "二等辺三角形","の","底辺上","の","二つの角","は互いに等しい、","","","","","1"},
        {"ゆえに、", "二等辺三角形","の","底辺上","の","二つの角","は互いに等しい、","","","","","3"},
        {"ゆえに、", "二等辺三角形","の","底辺上","の","二つの角","は互いに等しい、","","","","","5"},


        {"そして、", "等辺","を延長してできる","底辺下","の","二つの角","も互いに等しい。","","","","","1"},
        {"そして、", "等辺","を延長してできる","底辺下","の","二つの角","も互いに等しい。","","","","","3"},
        {"そして、", "等辺","を延長してできる","底辺下","の","二つの角","も互いに等しい。","","","","","5"},
    ...
    {
        {"命題I-6","","","","","","","","","","","99"},
        {"三角形", "の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","0"},
        {"三角形", "の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","2"},
        {"三角形", "の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","5"},
        {"三角形", "の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","99"},



        {"三角形ABC", "において","角ABC","と","角ACB","が等しいものとする。","","","","","","0"},
        {"三角形ABC", "において","角ABC","と","角ACB","が等しいものとする。","","","","","","2"},
        {"三角形ABC", "において","角ABC","と","角ACB","が等しいものとする。","","","","","","4"},


        {"このとき、", "辺AB","が","辺AC","に等しいと主張する。","","","","","","","1"},
        {"このとき、", "辺AB","が","辺AC","に等しいと主張する。","","","","","","","3"},

        {"もし", "AB","が","AC","と等しくなければ","どちらかが","長いことになる。","","","","","1"},
        {"もし", "AB","が","AC","と等しくなければ","どちらかが","長いことになる。","","","","","3"},

        {"AB", "が","AC","より長いとすれば、","AC","と同じ長さの","直線DB","を切り取ることができる","[命題I-3]","","","0"},
        {"AB", "が","AC","より長いとすれば、","AC","と同じ長さの","直線DB","を切り取ることができる","[命題I-3]","","","2"},
        {"AB", "が","AC","より長いとすれば、","AC","と同じ長さの","直線DB","を切り取ることができる","[命題I-3]","","","4"},
        {"AB", "が","AC","より長いとすれば、","AC","と同じ長さの","直線DB","を切り取ることができる","[命題I-3]","","","6"},



        {"このとき、", "直線DC","を引く","[公準P-1]","","","","","","","","1"},

        {"DB", "は","AC","と等しく、","BC","を共有しているから、","","","","","","0"},
        {"DB", "は","AC","と等しく、","BC","を共有しているから、","","","","","","2"},
        ...
        {"よって、", "底辺DC","は","AB","と等しく、","三角形DBC","と","三角形ACB","は等しい","[命題I-4]","","1"},
        {"よって、", "底辺DC","は","AB","と等しく、","三角形DBC","と","三角形ACB","は等しい","[命題I-4]","","3"},
        {"よって、", "底辺DC","は","AB","と等しく、","三角形DBC","と","三角形ACB","は等しい","[命題I-4]","","5"},
        {"よって、", "底辺DC","は","AB","と等しく、","三角形DBC","と","三角形ACB","は等しい","[命題I-4]","","7"},

        {"これは", "小さいもの","と","大きいもの","が等しいことになり矛盾である","[公理A-5]","","","","","","1"},
        {"これは", "小さいもの","と","大きいもの","が等しいことになり矛盾である","[公理A-5]","","","","","","3"},

        {"したがって、", "AB","と","AC","は等しい。","","","","","","","1"},
        {"したがって、", "AB","と","AC","は等しい。","","","","","","","3"},

        {"ゆえに、", "三角形の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","2"},
        {"ゆえに、", "三角形の","二つの角","が等しいならば、","それらに対する","二つの辺","も互いに等しい。","","","","","5"},
