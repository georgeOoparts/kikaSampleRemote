...
public class H_99_13_mojiHonban : MonoBehaviour {
    ...
    private string[,] m1_4 = new string[,]//m1_4w
    {
        ...
        {"すなわち、", "AB","と","DE","、","AC","と","DF","が","等しいとし","","","","","","","1","99","99"},
        {"すなわち、", "AB","と","DE","、","AC","と","DF","が","等しいとし","","","","","","","3","99","99"},
        {"すなわち、", "AB","と","DE","、","AC","と","DF","が","等しいとし","","","","","","","5","99","99"},
        {"すなわち、", "AB","と","DE","、","AC","と","DF","が","等しいとし","","","","","","","7","99","99"},
        {"すなわち、", "AB","と","DE","、","AC","と","DF","が","等しいとし","","","","","","","9","99","99"},
        ...
        {"角ABC", "と","角DEF","、","角ACB","と","角DFE","が","等しい","と主張する","","","","","","","0","99","99"},
        {"角ABC", "と","角DEF","、","角ACB","と","角DFE","が","等しい","と主張する","","","","","","","2","99","99"},
        {"角ABC", "と","角DEF","、","角ACB","と","角DFE","が","等しい","と主張する","","","","","","","4","99","99"},
        {"角ABC", "と","角DEF","、","角ACB","と","角DFE","が","等しい","と主張する","","","","","","","6","99","99"},
        {"角ABC", "と","角DEF","、","角ACB","と","角DFE","が","等しい","と主張する","","","","","","","8","99","99"},
        ...
        {"直線AC", "と","DF","も","一致する","","","","","","","","","","","","0","99","99"},
        {"直線AC", "と","DF","も","一致する","","","","","","","","","","","","2","99","99"},
        {"直線AC", "と","DF","も","一致する","","","","","","","","","","","","4","99","99"},

        {"したがって、", "点C","と","点F","は","一致する","","","","","","","","","","","1","99","99"},
        {"したがって、", "点C","と","点F","は","一致する","","","","","","","","","","","3","99","99"},
        {"したがって、", "点C","と","点F","は","一致する","","","","","","","","","","","5","99","99"},
        ...
        {"なぜならば、", "もし一致しないとすれば","同じ点を結ぶ直線","は","唯一つであること",
            "に","反するからである","[公準P-1]任意の点から任意の点","へ直線を引くこと。","",
            "","","","","","","1","99","99"},
        {"なぜならば、", "もし一致しないとすれば","同じ点を結ぶ直線","は","唯一つであること",
            "に","反するからである","[公準P-1]任意の点から任意の点","へ直線を引くこと。","",
            "","","","","","","2","99","99"},
