...
public class H_99_13_mojiHonban : MonoBehaviour
{
    ...
    private string[,] m1_5 = new string[,]
    {
        ...
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","0","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","2","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","4","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","6","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","8","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","9","99","99"},
        {"点F", "を","BD","上にとり、","AG",
            "を","AE","から","AF分","切り取ったとする","[命題I-3]","長さが異なる二つの直線の長い方","から短い方を切り取ること。","","","","10","11","12"},
        ...
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","0","99","99"},
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","2","99","99"},
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","3","99","99"},
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","6","99","99"},
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","8","99","99"},
        {"AF", "と","AG","は等しい","、そして","         ","AB","と","AC","は等しい","、なので","","","","","","9","99","99"},
        ...
        {"FA", "、","AC","はそれぞれ","GA","、","AB","と等しく、","","","","","","","","","7","99","99"},


        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","","","","","","1","99","99"},
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","","","","","","2","99","99"},
        ...
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","","","","","","6","99","99"},
        ...
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","","","","","","10","99","99"},


        {"さらに", "等辺","に対する","残りの角","もそれぞれ等しい","　　　　　　　",
            "[命題I-4]","　　　　　　　　　　　","二辺とその間の角が等しい三角形は","、残りの辺と角も互いに等しい。","","","","","","","1","99","99"},
        {"さらに", "等辺","に対する","残りの角","もそれぞれ等しい","　　　　　　　",
            "[命題I-4]","　　　　　　　　　　　","二辺とその間の角が等しい三角形は","、残りの辺と角も互いに等しい。","","","","","","","3","99","99"},
        {"さらに", "等辺","に対する","残りの角","もそれぞれ等しい","　　　　　　　",
            "[命題I-4]","　　　　　　　　　　　","二辺とその間の角が等しい三角形は","、残りの辺と角も互いに等しい。","","","","","","","4","99","99"},
        {"さらに", "等辺","に対する","残りの角","もそれぞれ等しい","　　　　　　　",
            "[命題I-4]","　　　　　　　　　　　","二辺とその間の角が等しい三角形は","、残りの辺と角も互いに等しい。","","","","","","","6","8","9"},
        ...
        {"すなわち、", "ACF","と","ABG","、","AFC","と","AGB","は等しい。","","","","","","","","8","99","99"},
