...
public class H_99_13_mojiHonban : MonoBehaviour {
    ...
    　  {"与えられた直線", "を","一辺","とする","正三角形","を","作図する事","","","","","","","","","","0","99","99"},
        ...
        {"BA", "を","半径とする","円ACE","を",
            ...
            "","","","","","","7","9","99"},
        //26
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","1","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","2","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","4","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","6","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","8","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","9","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","11","99","99"},
        {"そして","二つの円の交点", "C","と","A","と","B","を","結ぶ直線","CA","と","CB","を","描く","","","13","99","99"},
        //34
        ...
        //49
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","0","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","2","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","4","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","5","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","7","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","9","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","11","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","13","99","99"},
        {"BC", "と","AB","は","等しく、","BC","と","AC","は","等しい","ので、","AB","と","AC","は","等しい","15","99","99"},
        //58
