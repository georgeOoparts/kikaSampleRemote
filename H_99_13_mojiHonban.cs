...
public class H_99_13_mojiHonban : MonoBehaviour
{
    ...
    void Update() 
    {
        ...
        if (kyotu.mojiSwitch == 0)//kouri
        {
            ...
            if (kyotu.MCount == 0) {
                if (kyotu.rrCount < ka1.GetLength(0))
                    ...
                    kyouchouHenkanInt2 = int.Parse(ka1[kyotu.rrCount, ka1.GetLength(1) - 1]);
            }
            else if (kyotu.MCount == 1) {
                if (kyotu.rrCount < ka3.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(ka3[kyotu.rrCount, ka3.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(ka3[kyotu.rrCount, ka3.GetLength(1) - 1]);
            } 
            else if (kyotu.MCount == 2) {
                if (kyotu.rrCount < ka4.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(ka4[kyotu.rrCount, ka4.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(ka4[kyotu.rrCount, ka4.GetLength(1) - 1]);
            } 
            else if (kyotu.MCount == 3) {
                if (kyotu.rrCount < ka5.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(ka5[kyotu.rrCount, ka5.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(ka5[kyotu.rrCount, ka5.GetLength(1) - 1]);
            }
        }
        else if (kyotu.mojiSwitch == 1)//koujun
        {
            ...
            if (kyotu.MCount == 0) {
                if (kyotu.rrCount < kjp1.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(kjp1[kyotu.rrCount, kjp1.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(kjp1[kyotu.rrCount, kjp1.GetLength(1) - 1]);
            } 
            else if (kyotu.MCount == 1) {
                if (kyotu.rrCount < kjp2.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(kjp2[kyotu.rrCount, kjp2.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(kjp2[kyotu.rrCount, kjp2.GetLength(1) - 1]);
            } 
            else if (kyotu.MCount == 2) {
                if (kyotu.rrCount < kjp3.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(kjp3[kyotu.rrCount, kjp3.GetLength(1) - 2]);
                kyouchouHenkanInt2 = int.Parse(kjp3[kyotu.rrCount, kjp3.GetLength(1) - 1]);
            } 
        } 
        else if (kyotu.mojiSwitch == 2)//teigi
        {
            ...
            if (kyotu.MCount == 0) {
                ...
                kyouchouHenkanInt2 = int.Parse(tdi1[kyotu.rrCount, tdi1.GetLength(1) - 1]);
            } else if (kyotu.MCount == 1) {
                if (kyotu.rrCount < tdi15.GetLength(0))
        ...
        else if (kyotu.mojiSwitch == 3)//meidai 
        {
            ...
            if (kyotu.MCount == 0) {
                ...
                if (kyotu.rrCount < m1_2.GetLength(0))
                    kyouchouHenkanInt1 = int.Parse(m1_2[kyotu.rrCount, m1_2.GetLength(1) - 2]);///bug
    ...
    private string[,] m1_4 = new string[,]
    {
        ...
        {"なぜならば、", "もし一致しないとすれば","同じ点を結ぶ直線は","唯一つであることに","反するからである","[公準P-1]。","","","","","","99","99"/*,"99"*/},
        
        {"したがって、", "底辺BC","と","底辺EF","は一致し、互いに等しい","[公理A-4]。","","","","","","1","99"/*,"99"*/},
        {"したがって、", "底辺BC","と","底辺EF","は一致し、互いに等しい","[公理A-4]。","","","","","","3","99"/*,"99"*/},

        {"したがって、", "三角形ABC","は","三角形DEF","と完全に一致し、","互いに等しい","[公理A-4]","","","","","1","99"/*,"99"*/},
        {"したがって、", "三角形ABC","は","三角形DEF","と完全に一致し、","互いに等しい","[公理A-4]","","","","","3","99"/*,"99"*/},

        {"残りの角", "もそれぞれ一致し、","互いに等しい","[公理A-4]","","","","","","","","1","99"/*,"99"*/},

        {"つまり、", "ABC","と","DEF","、","ACB","と","DFE","は等しい","[公理A-4]","","1","99"/*,"99"*/},
        {"つまり、", "ABC","と","DEF","、","ACB","と","DFE","は等しい","[公理A-4]","","3","99"/*,"99"*/},
        {"つまり、", "ABC","と","DEF","、","ACB","と","DFE","は等しい","[公理A-4]","","5","99"/*,"99"*/},
        {"つまり、", "ABC","と","DEF","、","ACB","と","DFE","は等しい","[公理A-4]","","7","99"/*,"99"*/},
    ...
    private string[,] m1_5 = new string[,]
    {
        ...
        {"BD", "と","CE","を","AB","と","AC","をそれぞれ","延長した","直線とする","[公準P-2]","0","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","をそれぞれ","延長した","直線とする","[公準P-2]","2","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","をそれぞれ","延長した","直線とする","[公準P-2]","4","99"/*,"99"*/},
        {"BD", "と","CE","を","AB","と","AC","をそれぞれ","延長した","直線とする","[公準P-2]","6","99"/*,"99"*/},

        {"このとき、", "角ABC","と","ACB","、","角CBD","と","BCE","が等しいと主張する。","","","1","99"/*,"99"*/},
        {"このとき、", "角ABC","と","ACB","、","角CBD","と","BCE","が等しいと主張する。","","","3","99"/*,"99"*/},
        {"このとき、", "角ABC","と","ACB","、","角CBD","と","BCE","が等しいと主張する。","","","5","99"/*,"99"*/},
        {"このとき、", "角ABC","と","ACB","、","角CBD","と","BCE","が等しいと主張する。","","","7","99"/*,"99"*/},

        {"点F", "を","BD","上にとり、","AG","を","AE","から","AF分","切り取ったとする","[命題I-3]","0","99"/*,"99"*/},
        {"点F", "を","BD","上にとり、","AG","を","AE","から","AF分","切り取ったとする","[命題I-3]","2","99"/*,"99"*/},
        {"点F", "を","BD","上にとり、","AG","を","AE","から","AF分","切り取ったとする","[命題I-3]","4","99"/*,"99"*/},
        {"点F", "を","BD","上にとり、","AG","を","AE","から","AF分","切り取ったとする","[命題I-3]","6","99"/*,"99"*/},
        {"点F", "を","BD","上にとり、","AG","を","AE","から","AF分","切り取ったとする","[命題I-3]","8","99"/*,"99"*/},

        {"そして、", "直線FC","と","GB","を描く","[公準P-1]","","","","","","1","99"/*,"99"*/},
        {"そして、", "直線FC","と","GB","を描く","[公準P-1]","","","","","","3","99"/*,"99"*/},

        {"AF", "と","AG","、","AB","と","AC","は等しいから、","","","","0","99"/*,"99"*/},
        {"AF", "と","AG","、","AB","と","AC","は等しいから、","","","","2","99"/*,"99"*/},
        {"AF", "と","AG","、","AB","と","AC","は等しいから、","","","","4","99"/*,"99"*/},
        {"AF", "と","AG","、","AB","と","AC","は等しいから、","","","","6","99"/*,"99"*/},

        {"FA", "、","AC","はそれぞれ","GA","、","AB","と等しく、","","","","0","99"/*,"99"*/},
        {"FA", "、","AC","はそれぞれ","GA","、","AB","と等しく、","","","","2","99"/*,"99"*/},
        {"FA", "、","AC","はそれぞれ","GA","、","AB","と等しく、","","","","4","99"/*,"99"*/},
        {"FA", "、","AC","はそれぞれ","GA","、","AB","と等しく、","","","","6","99"/*,"99"*/},

        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","1","99"/*,"99"*/},
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","3","99"/*,"99"*/},
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","5","99"/*,"99"*/},
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","7","99"/*,"99"*/},
        {"その挟む", "角FAG","を共有するから、","底辺FC","と","底辺GB","は等しく、","三角形AFC","と","三角形AGB","は等しい。","9","99"/*,"99"*/},

        {"さらに", "等辺","に対する","残りの角","もそれぞれ等しい","[命題I-4]","","","","","","3","99"/*,"99"*/},

        {"すなわち、", "ACF","と","ABG","、","AFC","と","AGB","は等しい。","","","1","99"/*,"99"*/},
        {"すなわち、", "ACF","と","ABG","、","AFC","と","AGB","は等しい。","","","3","99"/*,"99"*/},
        {"すなわち、", "ACF","と","ABG","、","AFC","と","AGB","は等しい。","","","5","99"/*,"99"*/},
        {"すなわち、", "ACF","と","ABG","、","AFC","と","AGB","は等しい。","","","7","99"/*,"99"*/},

        {"AF", "と","AG","は等しいから、","","","","","","","","0","99"/*,"99"*/},
        {"AF", "と","AG","は等しいから、","","","","","","","","2","99"/*,"99"*/},

        {"そこから相等しい", "AB","と","AC","を引いた差の","BF","と","CG","は等しい","[公理A-3]","","1","99"/*,"99"*/},
        {"そこから相等しい", "AB","と","AC","を引いた差の","BF","と","CG","は等しい","[公理A-3]","","3","99"/*,"99"*/},
        {"そこから相等しい", "AB","と","AC","を引いた差の","BF","と","CG","は等しい","[公理A-3]","","5","99"/*,"99"*/},
        {"そこから相等しい", "AB","と","AC","を引いた差の","BF","と","CG","は等しい","[公理A-3]","","7","99"/*,"99"*/},
        ...
        {"等しい二辺", "に対する","残りの角","もそれぞれ等しい","[命題I-4]","","","","","","","0","99"/*,"99"*/},
        {"等しい二辺", "に対する","残りの角","もそれぞれ等しい","[命題I-4]","","","","","","","2","99"/*,"99"*/},
        ...
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","1","99"/*,"99"*/},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","3","99"/*,"99"*/},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","5","99"/*,"99"*/},
        {"これから", "CBG","と","BCF","を引いた残りの","ABC","と","ACB","は等しい","[公理A-3]","","7","99"/*,"99"*/},


        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","1","99"/*,"99"*/},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","3","99"/*,"99"*/},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","5","99"/*,"99"*/},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","7","99"/*,"99"*/},
        {"これらは", "三角形ABC","の","底辺上","にある。また","FBC","と","GCB","も等しく、これらは","底辺下","にある。","9","99"/*,"99"*/},
